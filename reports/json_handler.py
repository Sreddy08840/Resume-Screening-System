...
class JSONHandler:
    ...
    def _pretty_print_json(data: Any) -> str:
        """Pretty-print JSON data as a string"""
    ...
    def save_parsed_candidate(
        ...
        """
        Save parsed candidate data to a JSON file
        
        Args:
            candidate: Candidate object to save
            filename: Optional filename (defaults to candidate name if available)
    ...
    def load_parsed_candidate(filepath: str) -> Candidate:
        """
        Load parsed candidate data from a JSON file
    ...
    def load_reports() -> List[Dict[str, Any]]:
        """
        Load all analysis reports from the reports directory
    ...
    def load_job(file_path: str) -> Job:
        ...
        if validation_errors:
            ...
            raise InvalidJobDataError(f"Invalid job data: {', '.join(validation_errors)}")
